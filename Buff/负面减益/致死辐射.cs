...
namespace Revelation.Buff.负面减益
{
	...
	public class 致死辐射 : ModBuff
	{
		public override void SetStaticDefaults() {
			...
			Main.buffNoSave[Type] = false; // 使这个buff在退出或重进世界时不持续
		...
		public override void Update(Player player, ref int buffIndex) {
			player.GetModPlayer<AA>().lifeRegenDebuff= true;
		}
	}

	public class AA : ModPlayer
	{
