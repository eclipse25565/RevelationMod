...
namespace Revelation.Projectiles.武器弹幕.哀霜
{
	public class 阿尔特之霜弹幕 : ModProjectile
	{
		...
		public override void SetDefaults() {
			...
			Projectile.timeLeft = 120; // 射弹存在的剩余时间，写在这里为射弹的最大存在时间 (60 为 1 秒, 这里是 10 秒)
